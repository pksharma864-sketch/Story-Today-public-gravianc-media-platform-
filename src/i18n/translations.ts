...
export const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    formAuthorRole: 'Designation / Role (Press Reporter / News Reporter / Staff Reporter / Crime Reporter / Bureau Chief)',
  ...
  hi: {
    ...
    formAuthorRole: 'पहचान / पद (प्रेस रिपोर्टर / न्यूज रिपोर्टर / स्टाफ रिपोर्टर / क्राइम रिपोर्टर / ब्यूरो चीफ)',
