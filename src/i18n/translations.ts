...
export const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    enterAdminPasscode: 'Enter Admin Passcode (Default: admin123)',
  ...
  hi: {
    ...
    enterAdminPasscode: 'एडमिन पासवर्ड दर्ज करें (डिफ़ॉल्ट: admin123)',
...
export const categoriesMap: Record<string, { en: string; hi: string; icon: string }> = {
  ...
  politics: { en: 'Politics & Governance', hi: 'राजनीति व शासन', icon: 'Building2' },
  ...
  sports: { en: 'Sports', hi: 'खेलकूद', icon: 'Trophy' },
